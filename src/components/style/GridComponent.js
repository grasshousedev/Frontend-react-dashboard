                ...
                <div className="ui-section-column w-50pc">
                    ...
                    <div className="ui-section ui-form-container">
                        <div className="ui-form-field">
                            <div className="ui-form-label w-100">Width</div>
                            <div className="ui-form-input">
                                <input value={width || ''} onChange={e => setWidth(e.target.value ? +e.target.value : undefined)} />
                            </div>
                        </div>
                        <div className="ui-form-field">
                            <div className="ui-form-label w-100">Height</div>
                            <div className="ui-form-input"><input value={height || ''} onChange={e => setHeight(e.target.value ? +e.target.value : undefined)} /></div>
                        </div>
                    </div>
